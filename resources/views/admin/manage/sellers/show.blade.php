...
@section('content')
    <div class="container mt-4">
        ...
        <a href="{{ route('admin.manage.sellers.edit', $user) }}" class="btn btn-warning mt-3">Edytuj</a>
        <a href="{{ route('admin.manage.sellers.index') }}" class="btn btn-secondary mt-3">Powrót do listy</a>
    </div>
@endsection
