    ...
    <div class="container mt-4">
        ...
        <form method="POST" action="{{ route('admin.manage.users.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="postal_code" id="postal_code" class="form-control" value="{{ old('postal_code') }}" pattern="[0-9]{2}-[0-9]{3}" required>
            ...
            <a href="{{ route('admin.manage.users.index') }}" class="btn btn-secondary">Anuluj</a>
        </form>
    </div>
@endsection
