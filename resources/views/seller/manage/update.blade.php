...
@section('content')
    <div class="container mt-4">
        ...
        <form method="POST" action="{{ route('client.profile.update') }}">
            ...
            <div class="mb-3">
                <label for="seller_description" class="form-label">Opis sprzedawcy</label>
                <textarea name="seller_description" id="seller_description" class="form-control" maxlength="255" required>{{ old('seller_description', $seller_description ?? '') }}</textarea>
                @error('seller_description')<div class="text-danger">{{ $message }}</div>@enderror
            </div>
            <div class="mb-3">
